...
define('MAIL_FROM', 'girstask@yahoo.com');

// Mail transport available: "smtp", "sendmail", "mail" (PHP mail function), "postmark", "mailgun", "sendgrid"
define('MAIL_TRANSPORT', 'smtp');

// SMTP configuration to use when the "smtp" transport is chosen
define('MAIL_SMTP_HOSTNAME', 'smtp.mail.yahoo.com');
define('MAIL_SMTP_PORT', 465);
define('MAIL_SMTP_USERNAME', 'girstask@yahoo.com');
define('MAIL_SMTP_PASSWORD', '2679191redrose');
...
define('DB_PASSWORD', '7tg1r5vnha');

// Mysql/Postgres hostname
define('DB_HOSTNAME', 'localhost');

// Mysql/Postgres database name
define('DB_NAME', 'girs_taskboard');
